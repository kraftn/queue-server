...
where kind = find_type) and status = 'In the queue')$$;
...
SELECT pg_catalog.setval('public.main_queue_id_seq', 14648, true);
...
SELECT pg_catalog.setval('public.task_types_id_seq', 11, true);
